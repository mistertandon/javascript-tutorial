...
Technology.prototype.displayInfo = function () {
  console.log(
    this.frameworkName + " comes under " + this.licenseName + " license."
  );
};
...
console.log(
  "Object myTechnology_a and myTechnology_b are identical equal : " +
    myTechnology_abi
);
// Object myTechnology_a and myTechnology_b are identical equal : false

myTechnology_ab = myTechnology_a == myTechnology_b ? true : false;
console.log(
  "Object myTechnology_a and myTechnology_b are equal : " + myTechnology_ab
);
// Object myTechnology_a and myTechnology_b are equal : true

myTechnology_c = myTechnology_b;
myTechnology_bc = myTechnology_b == myTechnology_c ? true : false;
console.log(
  "Object myTechnology_c having reference to myTechnology_b, are they equal : " +
    myTechnology_bc
);
// Object myTechnology_c having reference to myTechnology_b, are they equal : true
